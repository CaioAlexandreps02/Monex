                            ...
                            <tbody>
                              {rowGroups.map((group, groupIndex) => (
                                ...
                                <tr className="align-top">
                                  <th className="snap-start w-[45vw] border-b border-r border-slate-200 bg-white p-1.5 text-left sm:w-[38vw] lg:sticky lg:left-0 lg:z-20 lg:w-[180px]">
                                    <div
                                      role="button"
                                      tabIndex={0}
                                        ...
                                        ...itemRows.map((item) => {
                                          ...
                                          return (
                                            <tr key={`${row.id}-${item.id}`} className="align-top">
                                              <th className="w-[45vw] border-b border-r border-slate-200 bg-slate-50/80 px-2 py-2.5 text-left sm:w-[38vw] lg:sticky lg:left-0 lg:z-20 lg:w-[180px]">
                              ...
                              <tr className="align-top">
                                <th className="w-[45vw] border-r border-t border-slate-200 bg-slate-900 px-3 py-3 text-left text-[10px] uppercase tracking-[0.16em] text-white sm:w-[38vw] lg:sticky lg:left-0 lg:z-30 lg:w-[180px]">
                                  Soma
                                </th>
                                {salaryCalendarMonths.map((monthItem) => {
